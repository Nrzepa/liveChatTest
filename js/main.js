		...
		if (searchParams.has('code')) {
			fetch(
				'https://messenger-dev5-dev-ed.develop.my.salesforce.com/services/oauth2/token',
				{
					...
					body: `grant_type=authorization_code&code=${searchParams.get(
						'code'
					)}&client_id=${clientId}&client_secret=${clientSecret}&redirect_uri=https://nrzepa.github.io/liveChatTest`,
				}
			)
				.then((response) => {
				...
				.then((data) => {
					...
					fetch(
						...
						.then((data) => {
							...
							const loElem = document.createElement(
